...
import MedusaSVG from '../../assets/images/medusa-launch.svg'
    ...
    const config = {
      ...
      widget:{
        about: {
          title: 'About',
          slug: 'about',
          content: "<p>Medusa is a real-time visualization of the <b>Daedalus project</b>. It acts like 'living artwork' where you can view the entire project history. Explore the enormous engineering work going on behind the scenes along with the active involvement of the community.</p>",
        },
        commitList: {
          title: 'Commit List',
          slug: 'commit-list'
